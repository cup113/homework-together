...
migrate((db) => {
  ...
  collection.listRule = "@request.auth.id = author.id || @request.auth.organizations.id ?= organization.id"
  collection.viewRule = "@request.auth.id = author.id || @request.auth.organizations.id ?= organization.id"
